...
2) 60 секунд выделяется для того, чтобы твой алгоритм нашел
и обезвредил максимальное количество багов. Через 60 секунд
...
победителей записывается твой лучший результат за 10ть 
попыток
